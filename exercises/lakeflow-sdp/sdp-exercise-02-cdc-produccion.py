...
# MAGIC
# MAGIC - **workshop.bronze.marketplace_clientes_cdc_raw**: 27 registros (20 INSERT + 5 UPDATE + 2 DELETE)
# MAGIC - **workshop.silver.marketplace_clientes_cdc_clean**: 27 registros (validados)
...
# MAGIC
# MAGIC - En **workshop.silver.marketplace_clientes_cdc_clean** > pestaña **Table metrics**
...
# MAGIC SELECT * FROM workshop.gold.dim_marketplace_cliente ORDER BY customer_id;
...
# MAGIC FROM workshop.bronze.marketplace_clientes_cdc_raw
# MAGIC UNION ALL
# MAGIC SELECT 
# MAGIC   'customers_clean' AS table_name, COUNT(*) AS row_count 
# MAGIC FROM workshop.silver.marketplace_clientes_cdc_clean
# MAGIC UNION ALL
# MAGIC SELECT 
# MAGIC   'customers (current)' AS table_name, COUNT(*) AS row_count 
# MAGIC FROM workshop.gold.dim_marketplace_cliente;
