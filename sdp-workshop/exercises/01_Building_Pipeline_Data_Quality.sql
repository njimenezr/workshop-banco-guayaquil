...
-- MAGIC
-- MAGIC 1. **Bronze**: `workshop.sdp_bronze.orders`
...
-- MAGIC FROM workshop.sdp_silver.orders_clean
...
-- MAGIC 2. Selecciona **Run table** `workshop.sdp_bronze.orders`
...
SELECT * FROM workshop.sdp_bronze.orders LIMIT 10;
...
SELECT * FROM workshop.sdp_gold.order_summary 
ORDER BY order_date;
...
SELECT 
  'orders' AS table_name, COUNT(*) AS row_count FROM workshop.sdp_bronze.orders
UNION ALL
SELECT 
  'orders_clean' AS table_name, COUNT(*) AS row_count FROM workshop.sdp_silver.orders_clean
UNION ALL
SELECT 
  'order_summary' AS table_name, COUNT(*) AS row_count FROM workshop.sdp_gold.order_summary;
